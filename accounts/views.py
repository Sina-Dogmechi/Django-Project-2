...
from .forms import UserRegistrationForm, UserVerifyForm, UserLoginForm
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if code_instance.is_expired():
                messages.error(request, 'Your code has expired', 'warning')
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, 'phone/password is wrong', 'danger')
